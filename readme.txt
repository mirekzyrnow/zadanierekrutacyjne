...
University Hub WordPress Theme, Copyright (C) 2016-2020, WEN Themes
University Hub is distributed under the terms of the GNU GPL

== Changelog ==

= 2.1 - Dec 08 2020 =
* Add: Editor Color Palette
* Add: Editor Text Size Palette
* Add: Frontend & Editor Styles
* Fix: Content width
...
* Update: Menu for keyboard navigation
* Update: Screenshot and images due to license issue
* Update: readme.txt and style.css as per the new requirements
* Remove: Sidr
...
= 1.1.1 - Nov 18 2019 =
* Remove: Unnecessary depends and version from stylesheet
* Update: Better handling of Google Fonts

= 1.1 - Nov 14 2019 =
* WP 5.3 compatibility
* Add: pot file for translation ready
* Fix: Site Title html structure
* Fix: Minor bug fixes
...
* Cycle2 http://jquery.malsup.com/cycle2/, (C) 2014 M. Alsup, Dual licensed: MIT/GPL
...
* jQuery Easy Ticker https://github.com/vaakash/jquery-easy-ticker, (c) 2014 Instaclick Inc., [MIT](http://opensource.org/licenses/MIT)

== Images ==

* All images are licensed under [CC0](http://creativecommons.org/publicdomain/zero/1.0/legalcode.txt)

* https://www.pexels.com/photo/adolescent-blur-check-enjoy-235558/
* https://www.pexels.com/photo/man-using-ballpoint-pen-374820/
* https://www.pexels.com/photo/man-reading-book-beside-woman-reading-book-545068/
